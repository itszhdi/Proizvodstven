    ...
    with closing(psycopg2.connect(
        ...
        with connection.cursor() as cursor:
            ...
            VALUES  ('Acoustic night', 19-04-2024, 'AITU Music Club invites you to a unique celebration of love and romance! Every year, on April 15th, Kazakhstan celebrates the magnificent holiday - Lovers’ Day, inspired by the wonderful Kazakh legend of love «Kozy-Korpesh - Bayan-Sulu»', 2, 2, 'Astana', '18:00:00', 'Open Space'),
                    ...
                    ('Отчетный концерт "Eurasia Band"', 11-22-2024, 'We invite Friends from AITU to attend the Eurasia Band reporting concert. Unforgettable impressions and a warm welcome await you!', 2,2, 'Astana', '17:00:00', 'Kazhymukan 11, edu&lab'),
                    ('СТУДЕНЧЕСКИЙ КИНОВЕЧЕР: Гарри Поттер и Кубок огня', 10-14-2024, 'Don't miss the chance to immerse yourself in the world of magic and spend time with friends! Come and get a charge of positive emotions!', 4,4, 'Astana', '18:00:00', 'Assembly Hall'),
                    ('Music Spooktacular', 10-31-2024, 'Through the fog of an October night, when the world of the living and the dead almost touch, we invite you to the “Music Spooktacular”', 2,2, 'Astana', '17:00:00', 'Assembly Hall');
